...
# Step 1. subir archivo a OpenaI embeddings ===
filepath = "./cryptocurrency.pdf"
file_object = client.files.create(file=open(filepath, "rb"), purpose="assistants")

# Step 2 - creo un asistente 
## este bloque se comenta para conversar con un axistente ya creado o existente 
...
#     Your ultimate goal is to facilitate a deeper understanding of complex scientific material, making it more accessible and comprehensible. Debes proporcionarme la respuesta en español""",
#     tools=[{"type": "retrieval"}],
#     model=model,
#     file_ids=[file_object.id],
# )

# === Obtengo el id del asistente  ===
## este bloque se comenta para conversar con un axistente ya creado o existente 
# assis_id = assistant.id
# print(assis_id)

# == Hardcoded ids to be used once the first code run is done and the assistant was created
#se utiliza unicamente luego de obtener los id por primera ves, es decir, despues de la creacion del asistente y hilo 
thread_id = "thread_2H5aUYQn551vRHXMDteXpcxP"
assis_id = "asst_PE5MshFF9ss29SRYBbwF58QG"

# == Step 3. Crear hilos
message = "What is mining?. Proporcioname la respuesta en español"
...
# se utiliza esto cuando ya tenemos el asistente y queremo mandar msj
...
run = client.beta.threads.runs.create(
    ...
    instructions="Please address the user as Bruce.Debes proporcionarme la respuesta en español",
)
